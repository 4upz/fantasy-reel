  ...
  return (
    <section id="how-it-works" className="py-24 px-6 bg-surface">
      <div className="max-w-6xl mx-auto">
        <h2 className="type-section text-center text-foreground mb-16">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="ui-preview-container">
            ...
            {!imageError ? (
              ...
              <div className="ui-preview-image bg-elevated flex items-center justify-center w-full aspect-[3/2]">
                <div className="text-center p-8">
                  ...
                  <p className="type-label text-foreground-secondary">Draft board preview</p>
                  <p className="type-body-sm text-foreground-secondary mt-1">See it live when you sign up</p>
                </div>
              </div>
            )}
